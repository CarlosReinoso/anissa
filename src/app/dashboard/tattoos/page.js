...
export default function TattoosDashboardPage() {
  ...
  const fetchSubcategories = async () => {
    try {
      setLoading(true);
      const response = await fetch("/api/subcategories?section=tattoos");
      ...
      <div className="min-h-screen bg-black text-white p-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-20">
            ...
            <p className="mt-4 text-gray-400">Loading tattoos...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400 mt-2">
              Manage your tattoo designs with categories and subcategories
            </p>
          </div>
        ...
        {subcategories.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-400 mb-8">
              Start by creating your first subcategory to organize your tattoo
              designs (e.g., tattoos, flashcards).
            </p>
            <Button
              onClick={handleAddArtwork}
              className="bg-secondary hover:bg-secondary/80"
