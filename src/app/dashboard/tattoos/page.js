...
export default function TattoosDashboardPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      const menuResponse = await fetch(
        "/api/menu-items?section=tattoos&includeSubcategories=true"
      );
      ...
      // Fetch all artworks for tattoos section with their relationships
      ...
      <div className="min-h-screen bg-black text-white p-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-20">
            ...
            <p className="mt-4 text-gray-400">Loading tattoos dashboard...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-black text-white p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold">Tattoos Dashboard</h1>
            <p className="text-gray-400 mt-2">
              Manage your tattoo artwork and menu structure
            </p>
        ...
        {showMenuManager && (
          <div className="mb-8">
            <MenuManager section="tattoos" onMenuChange={handleMenuChange} />
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-400 mb-8">
              Start by creating your first menu item to organize your tattoo
              designs (e.g., "Traditional", "Minimalist", "Custom Designs").
            </p>
          </div>
        ) : (
